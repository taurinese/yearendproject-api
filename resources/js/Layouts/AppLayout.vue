        ...
        <div class="container">
            <nav class="nav">
                <ul>
                    <li>
                        <inertia-link href="/">
                            <img class="nav-icons" src="img/account.svg" alt="account">
                    ...
                    <li>
                        <inertia-link href="/search">
                            <img class="nav-icons" src="img/search.svg" alt="account">
                    ...
                    <li>
                        <inertia-link href="/news">
                            <img class="nav-icons" src="img/promotion.svg" alt="account">
                    ...
                    <li>
                        <inertia-link href="/contact">
                            <img class="nav-icons" src="img/letter.svg" alt="account">
                    ...
                    <li>
                        <inertia-link href="/library">
                            <img class="nav-icons" src="img/guitar.svg" alt="account">
